...
class DeviceManager(object):
    ...
    def getFile(self, remoteFilename, localFilename):
        """
        Copy file from device (remoteFilename) to host (localFilename)
        """
    ...
    def dirExists(self, dirpath):
        """
        Return True if dirpath exists and is a directory on the device file system
        """
    ...
    def killProcess(self, processName, forceKill=False):
        """
        Kills the process named processName. If forceKill is True, process is killed regardless of state
        """
