...
.. automodule:: mozdevice.devicemanager
...
.. automethod:: DeviceManager.getProcessList(self)XS
...
.. automodule:: mozdevice.devicemanagerADB
.. autoclass:: DeviceManagerADB

DeviceManagerSUT implementation
-------------------------------

.. automodule:: mozdevice.devicemanagerSUT
.. autoclass:: DeviceManagerSUT

SUT-specific methods
````````````````````
For the purpose of use within Mozilla's internal automated testing,
DeviceManagerSUT has several methods that are not present in all
implementations. Please do not use them in code that is meant to be
interoperable.
